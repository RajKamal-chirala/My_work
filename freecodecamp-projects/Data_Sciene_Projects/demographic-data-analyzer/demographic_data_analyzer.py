...
def calculate_demographic_data(print_data=True):
    ...
    j =df[df['salary'] == '>50K']['native-country'].value_counts()
    k = df['native-country'].value_counts()
    highest_earning_country = (j/k).idxmax()
    highest_earning_country_percentage = round(((j/k)*100).max(), 1)

    # Identify the most popular occupation for those who earn >50K in India.
    l = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')]['occupation'].value_counts()
    top_IN_occupation = l.idxmax()
